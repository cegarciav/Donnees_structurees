...
xml_style = '<?xml-stylesheet href="estilazo.css"  type="text/css"?>' \
            ...
            '<!ELEMENT Service (Nom, Lignes)>' \
            '<!ELEMENT Lignes (Ligne+)>' \
            '<!ELEMENT Ligne (ID, Nom, Train)>' \
            '<!ELEMENT Train (ID, Ponctualites)>' \
            '<!ELEMENT Ponctualites (Entete, Ponctualite+)>' \
            '<!ELEMENT Entete (Date, Taux, PonctuelParRetard)>' \
