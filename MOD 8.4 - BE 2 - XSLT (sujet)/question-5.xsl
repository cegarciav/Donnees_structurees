          ...
          <div class="service">
            ...
            <div class="lines">
              <xsl:for-each select="ligne">
                ...
                <!--
                  Variables pour faire un match entre les couleurs
                  du fichier des couleurs et les lignes du fichier
                  des mesures
                -->
                ...
                <div class="line">
                  <h2>
                    <!--
                      attribut style pour donner la couleur au nom
                      de la ligne selon le fichier des couleurs
                    -->
